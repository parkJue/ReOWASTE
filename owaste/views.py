from .forms import ArticleForm, OreviewForm
from django.db.models import Q

from .models import Campaign, Shop, Nkreview, Oreview
...
def search(request):
    ...
    region_one = request.GET.get('region', '')
    ...
    if search_key != '':
        ...
        if region_one:
            q.add(Q(region=region_one), q.AND)
